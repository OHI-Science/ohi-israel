...
resilience_components = list('CP'  = c('layer'='cp_habitat_extent_rank'    , 'level'='region_id'),           # old: rnk_cp_habitat_extent
                             'HAB' = c('layer'='hab_presence'              , 'level'='region_id'))
pressures_components  = list('CP'  = c('layer'='cp_habitat_extent_rank'    , 'level'='region_id'),
